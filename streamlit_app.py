...
if st.session_state.slide_number>=2:
    ...
    L.markdown("Pycon Chile, Noviembre 2021, por Sebastián Flores ![this is an image link](https://raw.githubusercontent.com/sebastiandres/talk_2021_11_pyconcl/main/images/github.svg) @sebastiandres [sebastiandres.xyz](sebastiandres.xyz)")
    L.image("github.svg")
    L.markdown(
